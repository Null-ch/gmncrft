...
На сервере стоит защита от подмены ника (мод LoginSystem):
  - при первом заходе (один раз навсегда): /register твой_пароль твой_пароль
    (пароль вводится дважды подряд, для подтверждения)
  - при всех следующих подключениях:       /login твой_пароль
Без этого нельзя двигаться и пользоваться командами. Пароль никому не говори -
